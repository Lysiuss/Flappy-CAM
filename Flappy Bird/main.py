...
player_face = [f for f in listdir(r'{}Flappy Bird\Bird image'.format(path_dir)) if isfile(join(r'{}Flappy Bird\Bird image'.format(path_dir), f))]

background_image = [f for f in listdir(r'{}Flappy Bird\Background_images Stock'.format(path_dir)) if isfile(join(r'{}Flappy Bird\Background_images Stock'.format(path_dir), f))]

floor_image = [f for f in listdir(r'{}Flappy Bird\Floor images stock'.format(path_dir)) if isfile(join(r'{}Flappy Bird\Floor images stock'.format(path_dir), f))]
...
# Game sounds
GAME_SOUNDS = {}
GAME_SOUNDS['die'] = pygame.mixer.Sound(os.path.join(path_dir, r'Flappy Bird\Sounds\die.wav'))
GAME_SOUNDS['hit'] = pygame.mixer.Sound(os.path.join(path_dir, r'Flappy Bird\Sounds\hit.wav'))
GAME_SOUNDS['point'] = pygame.mixer.Sound(os.path.join(path_dir, r'Flappy Bird\Sounds\point.wav'))
GAME_SOUNDS['wing'] = pygame.mixer.Sound(os.path.join(path_dir, r'Flappy Bird\Sounds\wing.wav'))
...
background = pygame.image.load(os.path.join(path_dir, r'Flappy Bird\Background_images Stock\{}.jpg'.format(background_name))).convert()
floor = pygame.image.load(os.path.join(path_dir, r'Flappy Bird\Floor images stock\{}.png'.format(floor_name))).convert()
...
bird2 = pygame.image.load(os.path.join(path_dir, r'Flappy Bird\Bird image\{}.png'.format(player_one_avatar))).convert_alpha()
bird1 = pygame.image.load(os.path.join(path_dir, r'Flappy Bird\Bird image\{}.png'.format(player_one_avatar))).convert_alpha()
bird3 = pygame.image.load(os.path.join(path_dir, r'Flappy Bird\Bird image\{}.png'.format(player_one_avatar))).convert_alpha()
...
if number_players == "2" :
    ...
    bird2_1 = pygame.image.load(os.path.join(path_dir, r'Flappy Bird\Bird image\{}.png'.format(player_two_avatar))).convert_alpha()
    bird2_2 = pygame.image.load(os.path.join(path_dir, r'Flappy Bird\Bird image\{}.png'.format(player_two_avatar))).convert_alpha()
    bird2_3 = pygame.image.load(os.path.join(path_dir, r'Flappy Bird\Bird image\{}.png'.format(player_two_avatar))).convert_alpha()
...
pipe = [pygame.image.load(os.path.join(path_dir, r'Flappy Bird\PipesFolder\pipe_green.png')), pygame.image.load(os.path.join(path_dir, r'Flappy Bird\PipesFolder\pipe_blue.png')), pygame.image.load(os.path.join(path_dir, r'Flappy Bird\PipesFolder\pipe_yellow.png')), pygame.image.load(os.path.join(path_dir, r'Flappy Bird\PipesFolder\pipe_red.png'))]
